        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    @if($blog_cat != null)
                    <li class="breadcrumb-item" ><a href="{{route('blog_cat',$blog_cat->blog_id )}}"> {{$blog_cat->name}}</a></li>
                    @endif
                    <li class="breadcrumb-item active" aria-current="page">{{$blog->title ?? null}}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section class="category-page  py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="hero-img">
                        <div class="cat-floating-name">{{$blog->title}}</div>
                        <img src="{{asset($blog->image)}}" alt="" class="img-fluid" loading="lazy">
                    </div>

                    <div class="content-wrapper mt-5">
                        <div class="small-title">{{_i('Details')}}</div>
                        <div class="section-title fancy-orange">{{$blog->title}}</div>
                    ...
                    <div class="content-wrapper mt-5">
                        <div class="section-title fancy-orange">{{_i('Similar Blogs')}}</div>
                        <div class="row">
...
{{--                            <a href="{{asset($blog->attachment->file)}}" class="d-flex justify-content-between align-items-center" download="">--}}
{{--                                <p>--}}
{{--                                    <img src="{{$blog->attachment->file}}" alt="" class="img-fluid" loading="lazy">--}}
{{--                                    {{_i('Download File')}}--}}
{{--                                </p>--}}
