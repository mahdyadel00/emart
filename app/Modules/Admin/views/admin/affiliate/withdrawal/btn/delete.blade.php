...
<a class="btn btn-danger waves-effect waves-light color-white delete-btn" data-toggle="modal" data-url="{{ route('affiliate_withdrawal.destroy', $id) }}"  data-target="#delete-modal" data-id='{{ $id }}'><i class="ti-trash"></i>{{ _i('Delete') }}</a>