	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">{{ _i('Edit Email') }}</h5>
				...
				<form id="edit-email-form" class="j-pro" enctype="multipart/form-data" data-parsley-validate="" style="box-shadow:none; background: none">
					...
					<div class="j-unit">
						<div class="j-input">
							...
							<input type="text" id="email" name="email" placeholder="{{ _i('Email') }}" required>
						</div>
					...
					<div class='m-b-25'>
						...
						<select name="groups[]" multiple class="selectpicker form-control" id="groups">
					...
					<div class='m-b-25'>
						...
						<select name="country" class="selectpicker country form-control" title='{{ _i('Please Select Country') }}'>
					...
					<div class='m-b-25'>
						...
						<select name="city" class="selectpicker city form-control" title='{{ _i('Please Select Country') }}'>
						</select>
					</div>
				</form>
			</div>
