				...
				<form id="send_email_form" class="j-pro" enctype="multipart/form-data" data-parsley-validate=""
					...
					<div class="j-content">
						...
						<div class="row mb-1">
							<div class="col-md-12">
								<div class="form-group">
									<label for="exampleInputEmail1">{{ _i('Emails') }}</label>
									<select name="emails[]" class='selectpicker form-control' data-live-search=true multiple>
...
<script>
            $('#send_email_form').submit(function (e) {
                e.preventDefault();
                var url = "{{ route('mailing_list.send') }}";
