...
[
	'title' => _i('Create Invoices'),
	'subtitle' => _i('Create Invoice'),
	'activePageName' => _i('Create Invoices'),
	'activePageUrl' => '',
...
@section('content')
<div class="page-body">
	<form class="save_shipping_company" method="POST" action="{{route('invoice.store')}}" enctype="multipart/form-data" data-parsley-validate="">
		@csrf
		<div class="row">
			<div class="col-sm-4 ">
				<div class="card">
									...
									<div class="form-group row ">
										<div class="col-sm-12">
											<div class="input-group ">
												<input class="form-control " name="no" placeholder="{{_i('Invoice No')}}" required value="{{ $no }}">
											...
											<div class="form-group">
												...
												<div class="input-group">
													<input type="date" name="date" class="form-control expire_date" required>
												</div>
											</div>
											<div class="form-group">
												<label>{{ _i('Invoice Due Date') }}</label>
												<div class="input-group">
													<input type="date" name="due_date" class="form-control expire_date" required>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="form-group row ">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<div class="input-group">
													<input type="text" name="invoice_total" class="form-control" required>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="form-group row ">
										<div class="col-md-6">
											<select name='user_id' id="ajax-select" class="selectpicker with-ajax col-md-12" data-live-search="true" title='{{ _i('Select Client') }}'>
												...
												<option value='{{ $user->id }}' data-subtext='{{ $user->email }}'>{{ $user->name }}</option>
												@endforeach
											</select>
										</div>
										<div class="col-md-6">
					...
					<div class="card-block">
						<div class="card-body card-block text-center">
							<div class="form-group row ">
								...
								<div class="invoice-products col-md-12"></div>
							</div>
