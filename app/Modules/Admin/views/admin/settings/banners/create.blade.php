    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_add" class="form-horizontal" action="{{ url('admin/settings/banners/store') }}"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="title_add" class="form-control" name="title" required=""
                                    placeholder="{{ _i('Place Enter Banner Title') }}">
                            </div>
                        </div>
                        <!-- ================================== title =================================== -->
                        <div class="form-group row">
                            <label class=" col-sm-2 col-form-label"><?= _i('Link') ?> <span
                                    style="color: #F00;">*</span></label>
                            <div class="col-sm-10">
                                <input type="url" id="link_add" class="form-control" name="link" required=""
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="image">{{ _i('Image') }} <span
                                    style="color: #F00;">*</span></label>
                            <div class="col-sm-10">
                                <input type="file" name="image" id="image_add" class="btn btn-default" accept="image/*"
                                    required="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="description_add" class="form-control" name="description"
